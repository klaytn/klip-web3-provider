...
import { getDocumentOrThrow } from '@walletconnect/browser-utils';
import { IQRCodeModalOptions } from '@walletconnect/types';

import { KLIP_STYLE_SHEET } from './assets/style';
import Modal from './components/Modal';
import { ANIMATION_DURATION, KLIP_WRAPPER_ID, KLIP_MODAL_ID, KLIP_STYLE_ID } from './constants';
...
export function open(uri: string, cb: any, qrcodeModalOptions?: IQRCodeModalOptions) {
    ...
    ReactDOM.render(
        <Modal text={en} uri={uri} onClose={getWrappedCallback(cb)} qrcodeModalOptions={qrcodeModalOptions} />,
        wrapper,
    );
}
